...
export let team = [
    ...
    { id: 106, name: 'Siddharth Varma', role: 'Account Executive', department: 'Sales', status: 'Offline', joinDate: '2023-08-14', avatar: 'https://ui-avatars.com/api/?name=Siddharth+Varma&background=random' },
...
export let tasks = [
    ...
    { id: 993, title: 'Client Presentation', date: '2026-02-06', time: '14:00', location: 'Boardroom', assignedTo: 'Siddharth Varma', department: 'Sales', type: 'Meeting', status: 'pending' },
...
export let requests = [
    ...
    { id: 4, type: 'time_off', title: 'Sick Leave', description: 'Not feeling well today', payload: { reason: 'Sick' }, submitterName: 'Siddharth Varma', timestamp: '30m ago', status: 'pending' },
